export function InsightsCard() {
  return (
    <div className="h-full rounded-2xl border border-border/70 bg-background p-6 shadow-inner">
      <div className="space-y-4">
        <div className="space-y-1">
          <h2 className="text-lg font-semibold text-foreground">Key Insight</h2>
        ...
        <div className="grid gap-4 md:grid-cols-[minmax(0,220px)_1fr] md:items-start">
          <div className="space-y-3">
            ...
            <div className="space-y-1 text-sm text-muted-foreground">
              <h3 className="text-sm font-semibold text-foreground">Top retention clip</h3>
              <p className="text-xs">Highlighting your stickiest segment</p>
            </div>
          </div>
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <p>
                Replicate the pacing and storytelling beats from this moment in
                future uploads to reinforce loyalty and elevate overall watch
                curves.
              </p>
            </div>
          </div>
