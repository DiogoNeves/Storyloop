...
export function TwoColumnDetailLayout({
  ...
  return (
    <div
      className={`relative grid h-full min-h-[100dvh] w-full grid-cols-1 gap-6 px-6 py-10 sm:py-12 lg:h-[calc(100dvh-4rem)] lg:min-h-0 lg:grid-cols-3 lg:overflow-hidden lg:px-10 xl:px-16 ${className ?? ""}`}
    >
