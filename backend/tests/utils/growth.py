...
def seed_video_metrics(service: GrowthScoreService) -> tuple[str, str]:
    """Insert a consistent set of metrics for growth score tests.

    Returns the primary channel and video type used by most assertions.
    """
    ...
    records = [
        ...
        # Additional records ensure filtering by channel and video type works as expected.
        VideoMetricsRecord(
