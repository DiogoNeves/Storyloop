...
| npm | @codemirror/lang-cpp | 6.0.3 | MIT |
| npm | @codemirror/lang-css | 6.3.1 | MIT |
| npm | @codemirror/lang-go | 6.0.1 | MIT |
| npm | @codemirror/lang-html | 6.4.11 | MIT |
| npm | @codemirror/lang-java | 6.0.2 | MIT |
| npm | @codemirror/lang-javascript | 6.2.4 | MIT |
| npm | @codemirror/lang-jinja | 6.0.0 | MIT |
| npm | @codemirror/lang-json | 6.0.2 | MIT |
| npm | @codemirror/lang-less | 6.0.2 | MIT |
| npm | @codemirror/lang-liquid | 6.3.1 | MIT |
| npm | @codemirror/lang-markdown | 6.5.0 | MIT |
| npm | @codemirror/lang-php | 6.0.2 | MIT |
| npm | @codemirror/lang-python | 6.2.1 | MIT |
| npm | @codemirror/lang-rust | 6.0.2 | MIT |
| npm | @codemirror/lang-sass | 6.0.2 | MIT |
| npm | @codemirror/lang-sql | 6.10.0 | MIT |
| npm | @codemirror/lang-vue | 0.1.3 | MIT |
| npm | @codemirror/lang-wast | 6.0.2 | MIT |
| npm | @codemirror/lang-xml | 6.1.0 | MIT |
| npm | @codemirror/lang-yaml | 6.1.2 | MIT |
| npm | @codemirror/language | 6.12.1 | MIT |
| npm | @codemirror/language-data | 6.5.2 | MIT |
| npm | @codemirror/legacy-modes | 6.5.2 | MIT |
| npm | @codemirror/lint | 6.9.2 | MIT |
| npm | @codemirror/search | 6.5.11 | MIT |
...
| npm | @jridgewell/source-map | 0.3.11 | MIT |
| npm | @jridgewell/sourcemap-codec | 1.5.5 | MIT |
| npm | @jridgewell/trace-mapping | 0.3.31 | MIT |
| npm | @lezer/common | 1.5.0 | MIT |
| npm | @lezer/cpp | 1.1.5 | MIT |
| npm | @lezer/css | 1.3.0 | MIT |
| npm | @lezer/go | 1.0.1 | MIT |
| npm | @lezer/highlight | 1.2.3 | MIT |
| npm | @lezer/html | 1.3.13 | MIT |
| npm | @lezer/java | 1.1.3 | MIT |
| npm | @lezer/javascript | 1.5.4 | MIT |
| npm | @lezer/json | 1.0.3 | MIT |
| npm | @lezer/lr | 1.4.7 | MIT |
| npm | @lezer/markdown | 1.6.3 | MIT |
| npm | @lezer/php | 1.0.5 | MIT |
| npm | @lezer/python | 1.1.18 | MIT |
| npm | @lezer/rust | 1.0.2 | MIT |
| npm | @lezer/sass | 1.1.0 | MIT |
| npm | @lezer/xml | 1.0.6 | MIT |
| npm | @lezer/yaml | 1.0.3 | MIT |
| npm | @lukemorales/query-key-factory | 1.3.4 | MIT |
| npm | @marijn/find-cluster-break | 1.0.2 | MIT |
| npm | @milkdown/components | 7.18.0 | MIT |
| npm | @milkdown/core | 7.18.0 | MIT |
| npm | @milkdown/crepe | 7.18.0 | MIT |
| npm | @milkdown/ctx | 7.18.0 | MIT |
| npm | @milkdown/exception | 7.18.0 | MIT |
| npm | @milkdown/kit | 7.18.0 | MIT |
| npm | @milkdown/plugin-block | 7.18.0 | MIT |
| npm | @milkdown/plugin-clipboard | 7.18.0 | MIT |
| npm | @milkdown/plugin-cursor | 7.18.0 | MIT |
| npm | @milkdown/plugin-history | 7.18.0 | MIT |
| npm | @milkdown/plugin-indent | 7.18.0 | MIT |
| npm | @milkdown/plugin-listener | 7.18.0 | MIT |
| npm | @milkdown/plugin-slash | 7.18.0 | MIT |
| npm | @milkdown/plugin-tooltip | 7.18.0 | MIT |
| npm | @milkdown/plugin-trailing | 7.18.0 | MIT |
| npm | @milkdown/plugin-upload | 7.18.0 | MIT |
| npm | @milkdown/preset-commonmark | 7.18.0 | MIT |
| npm | @milkdown/preset-gfm | 7.18.0 | MIT |
| npm | @milkdown/prose | 7.18.0 | MIT |
| npm | @milkdown/react | 7.18.0 | MIT |
| npm | @milkdown/transformer | 7.18.0 | MIT |
| npm | @milkdown/utils | 7.18.0 | MIT |
| npm | @ocavue/utils | 1.3.1 | MIT |
| npm | @radix-ui/number | 1.1.1 | MIT |
| npm | @radix-ui/primitive | 1.1.3 | MIT |
| npm | @radix-ui/react-arrow | 1.1.7 | MIT |
| npm | @radix-ui/react-collection | 1.1.7 | MIT |
| npm | @radix-ui/react-compose-refs | 1.1.2 | MIT |
| npm | @radix-ui/react-context | 1.1.2 | MIT |
| npm | @radix-ui/react-dialog | 1.1.15 | MIT |
| npm | @radix-ui/react-direction | 1.1.1 | MIT |
| npm | @radix-ui/react-dismissable-layer | 1.1.11 | MIT |
| npm | @radix-ui/react-focus-guards | 1.1.3 | MIT |
| npm | @radix-ui/react-focus-scope | 1.1.7 | MIT |
| npm | @radix-ui/react-id | 1.1.1 | MIT |
| npm | @radix-ui/react-label | 2.1.8 | MIT |
| npm | @radix-ui/react-popper | 1.2.8 | MIT |
| npm | @radix-ui/react-portal | 1.1.9 | MIT |
| npm | @radix-ui/react-presence | 1.1.5 | MIT |
| npm | @radix-ui/react-primitive | 2.1.3 | MIT |
| npm | @radix-ui/react-primitive | 2.1.4 | MIT |
| npm | @radix-ui/react-select | 2.2.6 | MIT |
| npm | @radix-ui/react-slot | 1.2.3 | MIT |
| npm | @radix-ui/react-slot | 1.2.4 | MIT |
| npm | @radix-ui/react-switch | 1.2.6 | MIT |
| npm | @radix-ui/react-tooltip | 1.2.8 | MIT |
| npm | @radix-ui/react-use-callback-ref | 1.1.1 | MIT |
| npm | @radix-ui/react-use-controllable-state | 1.2.2 | MIT |
| npm | @radix-ui/react-use-effect-event | 0.0.2 | MIT |
| npm | @radix-ui/react-use-escape-keydown | 1.1.1 | MIT |
| npm | @radix-ui/react-use-layout-effect | 1.1.1 | MIT |
| npm | @radix-ui/react-use-previous | 1.1.1 | MIT |
| npm | @radix-ui/react-use-rect | 1.1.1 | MIT |
| npm | @radix-ui/react-use-size | 1.1.1 | MIT |
| npm | @radix-ui/react-visually-hidden | 1.2.3 | MIT |
| npm | @radix-ui/rect | 1.1.1 | MIT |
| npm | @rollup/plugin-babel | 5.3.1 | MIT |
| npm | @rollup/plugin-node-resolve | 15.3.1 | MIT |
| npm | @rollup/plugin-replace | 2.4.2 | MIT |
...
| npm | @types/debug | 4.1.12 | MIT |
| npm | @types/estree | 0.0.39 | MIT |
| npm | @types/estree | 1.0.8 | MIT |
| npm | @types/estree-jsx | 1.0.5 | MIT |
| npm | @types/hast | 3.0.4 | MIT |
| npm | @types/katex | 0.16.8 | MIT |
| npm | @types/lodash | 4.17.23 | MIT |
...
| npm | @types/unist | 2.0.11 | MIT |
| npm | @types/unist | 3.0.3 | MIT |
| npm | @ungap/structured-clone | 1.3.0 | ISC |
| npm | @vue/compiler-core | 3.5.26 | MIT |
| npm | @vue/compiler-dom | 3.5.26 | MIT |
| npm | @vue/compiler-sfc | 3.5.26 | MIT |
| npm | @vue/compiler-ssr | 3.5.26 | MIT |
| npm | @vue/reactivity | 3.5.26 | MIT |
| npm | @vue/runtime-core | 3.5.26 | MIT |
...
| npm | character-reference-invalid | 2.0.1 | MIT |
...
| npm | debug | 4.4.3 | MIT |
| npm | decode-named-character-reference | 1.2.0 | MIT |
...
| npm | hast-util-to-jsx-runtime | 2.3.6 | MIT |
| npm | hast-util-whitespace | 3.0.0 | MIT |
| npm | html-url-attributes | 3.0.1 | MIT |
| npm | idb | 7.1.1 | ISC |
| npm | idb | 8.0.3 | ISC |
| npm | inline-style-parser | 0.2.7 | MIT |
| npm | internal-slot | 1.1.0 | MIT |
| npm | is-alphabetical | 2.0.1 | MIT |
| npm | is-alphanumerical | 2.0.1 | MIT |
...
| npm | is-module | 1.0.0 | MIT |
| npm | is-negative-zero | 2.0.3 | MIT |
| npm | is-number-object | 1.1.1 | MIT |
| npm | is-obj | 1.0.1 | MIT |
| npm | is-plain-obj | 4.1.0 | MIT |
| npm | is-regex | 1.2.1 | MIT |
| npm | is-regexp | 1.0.0 | MIT |
...
| npm | magic-string | 0.25.9 | MIT |
| npm | magic-string | 0.30.21 | MIT |
| npm | markdown-table | 3.0.4 | MIT |
| npm | math-intrinsics | 1.1.0 | MIT |
| npm | mdast-util-definitions | 6.0.0 | MIT |
| npm | mdast-util-find-and-replace | 3.0.2 | MIT |
| npm | mdast-util-from-markdown | 2.0.2 | MIT |
| npm | mdast-util-gfm | 3.1.0 | MIT |
| npm | mdast-util-gfm-autolink-literal | 2.0.1 | MIT |
| npm | mdast-util-gfm-footnote | 2.1.0 | MIT |
| npm | mdast-util-gfm-strikethrough | 2.0.0 | MIT |
| npm | mdast-util-gfm-table | 2.0.0 | MIT |
| npm | mdast-util-gfm-task-list-item | 2.0.0 | MIT |
| npm | mdast-util-math | 3.0.0 | MIT |
| npm | mdast-util-mdx-expression | 2.0.1 | MIT |
...
| npm | micromark-core-commonmark | 2.0.3 | MIT |
| npm | micromark-extension-gfm | 3.0.0 | MIT |
| npm | micromark-extension-gfm-autolink-literal | 2.1.0 | MIT |
| npm | micromark-extension-gfm-footnote | 2.1.0 | MIT |
| npm | micromark-extension-gfm-strikethrough | 2.1.0 | MIT |
| npm | micromark-extension-gfm-table | 2.1.1 | MIT |
| npm | micromark-extension-gfm-tagfilter | 2.0.0 | MIT |
| npm | micromark-extension-gfm-task-list-item | 2.1.0 | MIT |
| npm | micromark-extension-math | 3.1.0 | MIT |
| npm | micromark-factory-destination | 2.0.1 | MIT |
| npm | micromark-factory-label | 2.0.1 | MIT |
| npm | micromark-factory-space | 2.0.1 | MIT |
| npm | micromark-factory-title | 2.0.1 | MIT |
| npm | micromark-factory-whitespace | 2.0.1 | MIT |
| npm | micromark-util-character | 2.1.1 | MIT |
| npm | micromark-util-chunked | 2.0.1 | MIT |
| npm | micromark-util-classify-character | 2.0.1 | MIT |
| npm | micromark-util-combine-extensions | 2.0.1 | MIT |
| npm | micromark-util-decode-numeric-character-reference | 2.0.2 | MIT |
| npm | micromark-util-decode-string | 2.0.1 | MIT |
| npm | micromark-util-encode | 2.0.1 | MIT |
| npm | micromark-util-html-tag-name | 2.0.1 | MIT |
| npm | micromark-util-normalize-identifier | 2.0.1 | MIT |
| npm | micromark-util-resolve-all | 2.0.1 | MIT |
| npm | micromark-util-sanitize-uri | 2.0.1 | MIT |
| npm | micromark-util-subtokenize | 2.1.0 | MIT |
...
| npm | pretty-bytes | 5.6.0 | MIT |
| npm | pretty-bytes | 6.1.1 | MIT |
| npm | pretty-format | 27.5.1 | MIT |
| npm | property-information | 7.1.0 | MIT |
| npm | prosemirror-changeset | 2.3.1 | MIT |
| npm | prosemirror-commands | 1.7.1 | MIT |
| npm | prosemirror-drop-indicator | 0.1.3 | MIT |
| npm | prosemirror-dropcursor | 1.8.2 | MIT |
| npm | prosemirror-gapcursor | 1.4.0 | MIT |
| npm | prosemirror-history | 1.5.0 | MIT |
| npm | prosemirror-inputrules | 1.5.1 | MIT |
| npm | prosemirror-keymap | 1.2.3 | MIT |
| npm | prosemirror-model | 1.25.4 | MIT |
| npm | prosemirror-safari-ime-span | 1.0.2 | MIT |
| npm | prosemirror-schema-list | 1.5.1 | MIT |
| npm | prosemirror-state | 1.4.4 | MIT |
| npm | prosemirror-tables | 1.8.5 | MIT |
| npm | prosemirror-transform | 1.10.5 | MIT |
| npm | prosemirror-view | 1.41.4 | MIT |
...
| npm | regenerate-unicode-properties | 10.2.2 | MIT |
| npm | regexp.prototype.flags | 1.5.4 | MIT |
| npm | regexpu-core | 6.4.0 | MIT |
| npm | regjsgen | 0.8.0 | MIT |
| npm | regjsparser | 0.13.0 | BSD-2-Clause |
| npm | remark | 15.0.1 | MIT |
| npm | remark-gfm | 4.0.1 | MIT |
| npm | remark-inline-links | 7.0.0 | MIT |
| npm | remark-math | 6.0.0 | MIT |
| npm | remark-parse | 11.0.0 | MIT |
| npm | remark-rehype | 11.1.2 | MIT |
...
| npm | trough | 2.2.0 | MIT |
| npm | tslib | 2.8.1 | 0BSD |
| npm | type-fest | 0.16.0 | (MIT OR CC0-1.0) |
...
| npm | unicode-match-property-value-ecmascript | 2.2.1 | MIT |
| npm | unicode-property-aliases-ecmascript | 2.2.0 | MIT |
| npm | unified | 11.0.5 | MIT |
| npm | unique-string | 2.0.0 | MIT |
| npm | unist-util-is | 6.0.1 | MIT |
| npm | unist-util-position | 5.0.0 | MIT |
| npm | unist-util-remove-position | 5.0.0 | MIT |
| npm | unist-util-stringify-position | 4.0.0 | MIT |
| npm | unist-util-visit | 5.0.0 | MIT |
...
| npm | use-isomorphic-layout-effect | 1.2.1 | MIT |
| npm | use-latest | 1.3.0 | MIT |
| npm | use-local-storage-state | 19.5.0 | MIT |
...
| npm | webidl-conversions | 4.0.2 | BSD-2-Clause |
| npm | whatwg-url | 7.1.0 | MIT |
| npm | which | 2.0.2 | ISC |
...
| npm | workbox-cacheable-response | 7.4.0 | MIT |
| npm | workbox-core | 7.4.0 | MIT |
| npm | workbox-expiration | 7.4.0 | MIT |
| npm | workbox-google-analytics | 7.4.0 | MIT |
| npm | workbox-navigation-preload | 7.4.0 | MIT |
| npm | workbox-precaching | 7.4.0 | MIT |
| npm | workbox-range-requests | 7.4.0 | MIT |
| npm | workbox-recipes | 7.4.0 | MIT |
| npm | workbox-routing | 7.4.0 | MIT |
| npm | workbox-strategies | 7.4.0 | MIT |
